...
public class RantNRaveClient {
	...
	private static JSONObject init() {
		...
		Meta meta = new Meta();
		batch.setMeta(meta);
		meta.setAgent_id("aid");
		meta.setCase_id("cid");
		meta.setCustomer_email("Matt.baker@fil.com");
		meta.setCustomer_firstname("Matt");
		meta.setCustomer_id("cust_id");
		meta.setCustomer_lastname("Baker");
		meta.setCustomer_mobilephone("07947552712");
		meta.setCustomer_phone("07947552712");
